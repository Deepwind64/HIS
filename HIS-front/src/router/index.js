      ...
      children: [
        {
          ...
          name: "窗口挂号",
          component: () =>
            import("../views/registration/onsite_registratiion.vue"),
          meta: {
            isLogin: true,
          },
        },
        {
          ...
          name: "窗口退号",
          component: () =>
            import("../views/registration/registration_record.vue"),
          meta: {
            isLogin: true,
          },
        },
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          name: "医生诊疗：病历首页",
          component: () =>
            import("../views/physician/patient/home_medical_record.vue"),
          meta: {
            isLogin: true,
          },
        },
        {
          ...
          name: "医生诊疗：检查申请",
          component: () =>
            import("../views/physician/patient/check_request.vue"),
          meta: {
            isLogin: true,
          },
        },
        {
          ...
          name: "医生诊疗：检验申请",
          component: () =>
            import("../views/physician/patient/inspection_request.vue"),
          meta: {
            isLogin: true,
          },
        },
        {
          ...
          name: "医生诊疗：检查结果",
          component: () =>
            import("../views/physician/patient/check_results.vue"),
          meta: {
            isLogin: true,
          },
        },
        {
          ...
          name: "医生诊疗：检验结果",
          component: () =>
            import("../views/physician/patient/inspection_results.vue"),
          meta: {
            isLogin: true,
          },
        },
        {
          ...
          name: "医生诊疗：门诊确诊",
          component: () =>
            import("../views/physician/patient/outpatient_diagnosis.vue"),
          meta: {
            isLogin: true,
          },
        },
        {
          ...
          name: "医生诊疗：开设处方",
          component: () =>
            import("../views/physician/patient/write_prescription.vue"),
          meta: {
            isLogin: true,
          },
        },
        {
          ...
          name: "医生诊疗：处置申请",
          component: () =>
            import("../views/physician/patient/disposal_request.vue"),
          meta: {
            isLogin: true,
          },
        },
        {
          ...
          name: "医生诊疗：费用查询",
          component: () =>
            import("../views/physician/patient/expense_query.vue"),
          meta: {
            isLogin: true,
          },
        },
